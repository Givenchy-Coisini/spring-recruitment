...
## 12.纯 js 如何获取 scrolltop 的值

## 13.arguments 如何转数组

## 14.移动端和 pc 端 click 事件为什么差了 300ms
...
## 17.三句话概括所有值传递类型、引用传递类型 以及如何用引用的方式传递值类型
...
```
### 27.为什么引入TS TS有什么优势
### 28.TS中的Interface和Type的区别是什么

## 29.for in 和for of 的区别

## 30.TS的泛型出现是为了解决什么问题的
